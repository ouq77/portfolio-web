...
import {ABJ, ACC, ADL, AKL, AMS, ARN, ATL, BFN, BGO, BKK, BKKN, BOM, BOO, BUQ, CBR, CDG, CHC, CPH, CPT, DAR,
  DKR, DPS, DRW, DUR, EBB, ELS, EZE, FIH, FRA, GBE, GIS, GRJ, GRU, HKG, HKGN, HKT, HLZ, HRE, IAD, JFK, JNB, KBV,
  KIM, KIX, LAD, LGA, LHR, LOS, LUN, LVI, MBD, MEL, MIA, MPM, MRU, NBO, NPL, NRT, NSN, PEK, PER, PLZ, PVG, RAR,
  ROT, SID, SIN, SJV, SYD, TIU, TOS, TRD, TRG, USM, WDH, WLG, YVR, ZQN, ZRH} from './airports';
