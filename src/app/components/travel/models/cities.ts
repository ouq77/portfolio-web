import { City, ICity } from '../definitions/city';
import { Icon, IIcon } from '../definitions/icon';
...
const prevIcon: IIcon = new Icon(PREVIOUS_MARKER_SIZE, PREVIOUS_ICON_URL);
const curIcon: IIcon = new Icon(CURRENT_MARKER_SIZE, CURRENT_ICON_URL);
