...
const fetchInstaUrls = fetch(`https://graph.facebook.com/oauth/access_token?client_id=${FB_APP_ID}&client_secret=${FB_APP_SECRET}&grant_type=client_credentials`)
  .then(res => res.json())
  .then(({ access_token }) => {
...
const instaCache = () => {
  ...
  return memoryCache.wrap('imageUrls', () => fetchInstaUrls)
}
